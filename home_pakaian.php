                            ...
                            if($_SERVER['REQUEST_METHOD'] == "POST"){
                             $pencarian =trim(mysqli_escape_string($koneksi, $_POST['pencarian']));
                               if($pencarian !==' ') {
                                 ...
                                 $query= "SELECT * FROM tb_produk WHERE kategori LIKE '%Pakaian Pria%' LIMIT $posisi, $batas" ;
                                 $queryJml="SELECT * FROM tb_produk WHERE kategori LIKE '%Pakaian Pria%' ";
                                 $no = $posisi + 1;
                               }
                            }else{
                              $query= "SELECT * FROM tb_produk WHERE kategori LIKE '%Pakaian Pria%' LIMIT $posisi, $batas" ;
                                  ...
                                  <div class="col-md-4 text-center col-sm-6 col-xs-6">
                                      <div class="thumbnail product-box">
                                          ...
                                          <div class="caption">
                                              ...
                                              <p class="btn btn-info">Rp.<?php echo number_format($perproduk['harga_produk']); ?></p>
