...
<!-- 
 ...
 <!--pelanggan yang beli harus pelanggan yg login -->
 	<?php 
 		...
 		$id_pelangganygBELI = $pecah['id_pelanggan'];
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			Tanggal Belanja : <?php echo $pecah['tanggal_pembelian']; ?> <br>
			Total Belanja + Ongkir : Rp.<?php echo number_format($pecah['total_pembelian']); ?>
		</div>
		<div class="col-md-4">
			<h3>Pelanggan</h3>
			<strong>Nama Pembeli :<?php echo $pecah ['nama_pelanggan']; ?></strong><br>
			<p>
			 	No Telepon : <?php echo $pecah['telepon']; ?> <br>
				Email : <?php echo $pecah['email_pelanggan']; ?>
			 </p>
		</div>
		<div class="col-md-4">
			<h3>Pengiriman</h3>
			<strong><?php echo $pecah['nama_kota']; ?></strong><br>
			Ongkos Kirim : Rp.<?php echo number_format($pecah['tarif']); ?> <br>
			Alamat : <?php echo $pecah['alamat_pengiriman']; ?>
		</div>
 		...
 		<div class="row">
 			<div class="col-md-12">
 				<div class="alert alert-info">
 					<p>
 						Silahkan melakukan pembayaran sebesar Rp.<?php echo number_format($pecah['total_pembelian']); ?> paling lambat 3 jam setelah melakukan transaksi pembelian ke:<br>
