<div class="col-md-9 ">
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Pakaian Anak</li>
                    </ol>
                </div>
                            ...
                            if($_SERVER['REQUEST_METHOD'] == "POST"){
                             $pencarian =trim(mysqli_escape_string($koneksi, $_POST['pencarian']));
                               if($pencarian !==' ') {
                                 ...
                                 $query= "SELECT * FROM tb_produk WHERE kategori='Pakaian Anak' LIMIT $posisi, $batas  " ;
                                 $queryJml="SELECT * FROM tb_produk WHERE kategori='Pakaian Anak' ";
                                 $no = $posisi + 1;
                               }
                            }else{
                              $query= "SELECT * FROM tb_produk WHERE kategori='Pakaian Anak' LIMIT $posisi, $batas  " ;
