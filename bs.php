...
<!-- fav and touch icons -->
	...
	<!-- css najwashop -->
	<link id="callCss" rel="stylesheet" href="admin/css/themes/bootstrap.min.css" media="screen"/>
...
<div id="welcomeLine" class="row">
	...
	<div class="pull-right">
		...
		<a href="product_summary.html"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> [ 5 ] Itemes in your cart </span> </a> 
	</div>
	</div>
</div>
<!-- Navbar ================================================== -->
...
<!-- Sidebar end=============================================== -->
		...
		<h4>Latest Products </h4>
			  <ul class="thumbnails col-sm-6 col-xs-6">
				<li class="span3 col-sm-6 col-xs-6">
				  <div class="thumbnail">
					<a  href="product_details.html"><img src="themes/images/products/6.jpg" alt=""/></a>
					<div class="caption">
					  <h5>Product name</h5>
